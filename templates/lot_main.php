            ...
            <?php if (isset($_SESSION['user']) && $lot['no-bet']): ?>
                <div class="lot-item__state">
                    ...
                    <form class="lot-item__form" action="lot.php?id=<?=$lot['id'];?>" method="post">
                        <div class="lot-item__form-item <?=$lot['class'];?>">
                            <label for="cost">Ваша ставка</label>
                            <input id="cost" type="text" name="cost" placeholder="<?=$lot['min-bet'];?>"> <!-- number required placeholder="12 000" -->
                            <span class="form__error"><?=$lot['message'];?></span>
                        </div>
